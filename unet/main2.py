...
if __name__ == '__main__':
    ...
    if data_mode:
        ...
        #path to save sound2
        path_save_sound2 = args.path_save_sound2
        ...
        weights_path = args2.weights_folder
        #pre trained model
        name_model = args2.name_model
        #Training from scratch vs training from pre-trained weights
        training_from_scratch = args2.training_from_scratch
        #epochs for training
        epochs = args2.epochs
        ...
        audio_dir_prediction = args2.audio_dir_prediction
        #directory to save the denoise sound
        dir_save_prediction = args2.dir_save_prediction
        #Name noisy sound file to denoise
        audio_input_prediction = args2.audio_input_prediction
        #Name of denoised sound file to save
        audio_output_prediction = args2.audio_output_prediction
        # Sample rate to read audio
