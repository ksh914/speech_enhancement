...
parser.add_argument('--noise_dir', 
                    default='./data/Train/noise/alarm', type=str)

parser.add_argument('--voice_dir', 
                    default='./data/Train/clean_voice/man_1', type=str)

#folders where to save spectrograms, time series and sounds for training / QC

parser.add_argument('--path_save_spectrogram', 
                    default='./fft/man_1/alarm/', type=str)

parser.add_argument('--path_save_time_serie', 
                    default='./data/Train/time_serie/man_1/alarm/', type=str)

parser.add_argument('--path_save_sound', 
                    default='./data/Train/sound/man_1/alarm/', type=str)

parser.add_argument('--path_save_sound2',
                    default='./demo_data/test/man_1/alarm/', type=str)


#How much frame to create in data_creation mode
parser.add_argument('--nb_samples', default=4, type=int)
...
parser.add_argument('--weights_folder', default='./weights/man_1/alarm', type=str)
...
parser.add_argument('--audio_dir_prediction', default='./fft/woman_1/alarm/', type=str)
#directory to save the denoise sound (prediction mode)
parser.add_argument('--dir_save_prediction', default='./fft/woman_1/alarm/save_predictions/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['fft_filter_out.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='fft_denoise_t3.wav', type=str)
