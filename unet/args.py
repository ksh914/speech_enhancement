...
parser.add_argument('--frame_length', default=16128, type=int)
# hop length for clean voice files separation (no overlap)
parser.add_argument('--hop_length_frame', default=16128, type=int)
